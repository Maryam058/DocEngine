...
![Patients screen showing the patient search field, a list of matching patients, and a selected patient's record with a Book Appointment button](../../assets/select_patient.png)
...
![Select Date & Time screen showing a calendar and a list of available appointment times](../../assets/date-time.png)
...
![Book an Appointment form showing patient name, contact information, preferred date and time, and a notes/visit reason field](../../assets/book-appointment.png)
...
![Review Appointment screen showing the patient, provider, department, clinic, date, time, and reason for visit, with Back and Confirm Booking options](../../assets/confirm-booking.png)
