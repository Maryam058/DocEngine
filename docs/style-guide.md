...
> **Draft status:** This page is an AI-generated draft. It has not been reviewed, edited, or approved by a human. Do not treat any part of this content as final or authoritative until it has completed human review and been published through the DocEngine editorial workflow.

## 1. Overview and Purpose

This style guide defines how documentation is written, structured, and reviewed across the DocEngine platform. It applies to all content published to the `docs/` site, including the user guide, API reference, and release notes, regardless of whether the content originated from a PDF import, a Markdown source, an OpenAPI spec, or an AI-drafted page.
...
|------|------|----------|--------------|
| `document_id` | string | Yes | The unique identifier of the document to publish. |
